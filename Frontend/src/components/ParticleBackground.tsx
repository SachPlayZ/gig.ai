...
const ParticleBackground = () => {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden">
      ...
      <div className="absolute -top-20 right-[20%] w-[15vw] h-[60vh] bg-gradient-to-b from-white to-transparent opacity-10 rotate-15 transform-gpu blur-md"></div>
      <div className="absolute -top-10 right-[22%] w-[8vw] h-[40vh] bg-gradient-to-b from-white to-transparent opacity-15 rotate-12 transform-gpu blur-sm"></div>
